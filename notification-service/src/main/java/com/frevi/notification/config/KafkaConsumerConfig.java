...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, MessageDto> userDtoConsumerFactory() {
        return consumerFactory(MessageDto.class);
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, MessageDto>> kafkaListenerContainerFactoryUserDto(ConsumerFactory<String, MessageDto> consumerFactory) {
