...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, OrderCreateRequest> userDtoConsumerFactory() {
        return consumerFactory(OrderCreateRequest.class);
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderCreateRequest>> kafkaListenerContainerFactoryUserDto(ConsumerFactory<String, OrderCreateRequest> consumerFactory) {
